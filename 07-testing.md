...
This is where domain expertise is critical. You as the human in the loop must decide how the sytem is judged to be correct, and then encode that discernment into your testing and evaluation strategy.
